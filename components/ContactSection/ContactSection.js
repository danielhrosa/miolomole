  ...
  return (
    <S.ContactSection>
      <Container>
        ...
        <S.ContactForm>
          <TextContactInfo props={props} isLoggedIn={isLoggedIn} textKey="textContactOriginals" textLabel="Envio de originais suspenso. Acompanhe nas redes sociais para saber sobre novas chamadas" />
